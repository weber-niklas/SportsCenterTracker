...
def run_occupancy_data_collection():

    logging.info("Starting occupancy data collection")
    ...
    while True:
        try:
            ...
            logging.info("Stopping occupancy data collection")
            break

if __name__ == "__main__":
    run_occupancy_data_collection()
